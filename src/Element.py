...
class Element:
    ...
    o name is the name of the element (the key of the element dictionary)
    o nodcoord: array to keep the nodal coordinates
    o lcoord is to keep the actual local coordinates
    """
    ...
    def mapNodalVar(self, nodalvar, lcoord=None):
        ...
        return N.sum(nodalvar * sh[N.newaxis,:], 1)

    def mapIntPointVar(self, intpointvar, lcoord=None):
...
if __name__ == '__main__':
    ...
    print e.containsPoint([0., 2.01], accuracy=0.01)

    print e.findGlobalCoord([0., 1.])
